...
mixin _$RegisterResponseModel {
 ...
 bool get success; String get message; String? get data;@JsonKey(name: 'errorCode') String? get errorCode;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RegisterResponseModel&&(identical(other.success, success) || other.success == success)&&(identical(other.message, message) || other.message == message)&&(identical(other.data, data) || other.data == data)&&(identical(other.errorCode, errorCode) || other.errorCode == errorCode));
}
...
@override
String toString() {
  return 'RegisterResponseModel(success: $success, message: $message, data: $data, errorCode: $errorCode)';
}
...
@useResult
$Res call({
 bool success, String message, String? data,@JsonKey(name: 'errorCode') String? errorCode
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool success,  String message,  String? data, @JsonKey(name: 'errorCode')  String? errorCode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RegisterResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool success,  String message,  String? data, @JsonKey(name: 'errorCode')  String? errorCode)  $default,) {final _that = this;
switch (_that) {
case _RegisterResponseModel():
return $default(_that.success,_that.message,_that.data,_that.errorCode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool success,  String message,  String? data, @JsonKey(name: 'errorCode')  String? errorCode)?  $default,) {final _that = this;
switch (_that) {
case _RegisterResponseModel() when $default != null:
return $default(_that.success,_that.message,_that.data,_that.errorCode);case _:
  return null;
...
class _RegisterResponseModel implements RegisterResponseModel {
  const _RegisterResponseModel({required this.success, required this.message, this.data, @JsonKey(name: 'errorCode') this.errorCode});
